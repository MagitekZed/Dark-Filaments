...
import { GALAXY_SPIN_RATE, GALAXY_VIEW_TILT } from '../sceneParams'
...
// Spin rate + view tilt are imported from sceneParams (NOTES.md coupling #1)
// so the stars track the disc and share the galaxy's tilt — no local copy to
// drift out of sync with Galaxy.tsx / the BH group.
...
export function TwinklingStars() {
  ...
  return (
    // outer group: same tilt as the galaxy (shared via sceneParams)
