# Long-burn calibration — 2026-05-14T06:50:10.962Z
...
- DNF: 0/20
- Time to complete target tier p10 / p50 / p90: 1d 19h / 2d 12h / 3d 8h
...
| T4 | 20h 0m | 15h 15m / 1d 18h | 1d 0h - 2d 0h | -44.4% | HIGH-under | 1.73e+11 / 3.13e+10 | 5.52× | above-band |

## Cross-pairing comparison (all pairings)

| Pairing | Mode | Weight | N | DNF | p10 | p50 | p90 | Total drift | T4 band | Kind |
|---|---|---|---|---|---|---|---|---|---|---|
| realistic-engaged × comp-hoarder | completion | primary | 20 | 0/20 | 1d 19h | 2d 12h | 3d 8h | -22.0% [HIGH-under] | 5.52× [above-band] | engagement-profile |

## Anomalies / flags

- realistic-engaged × comp-hoarder total: drift -22.0% [HIGH-under]
- realistic-engaged × comp-hoarder T4: p50 20h 0m vs target 1d 0h - 2d 0h → -44.4% [HIGH-under]
