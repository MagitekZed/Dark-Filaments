# Long-burn calibration — 2026-05-14T07:05:56.806Z
...
- DNF: 0/20
- Time to complete target tier p10 / p50 / p90: 2d 6h / 2d 18h / 4d 7h
...
| T4 | 1d 3h | 20h 48m / 2d 6h | 1d 0h - 2d 0h | -23.8% | HIGH-under | 3.39e+11 / 1.00e+11 | 3.39× | above-band |

## Cross-pairing comparison (all pairings)

| Pairing | Mode | Weight | N | DNF | p10 | p50 | p90 | Total drift | T4 band | Kind |
|---|---|---|---|---|---|---|---|---|---|---|
| realistic-engaged × comp-hoarder | completion | primary | 20 | 0/20 | 2d 6h | 2d 18h | 4d 7h | -13.5% [within] | 3.39× [above-band] | engagement-profile |

## Anomalies / flags

- realistic-engaged × comp-hoarder T4: p50 1d 3h vs target 1d 0h - 2d 0h → -23.8% [HIGH-under]
