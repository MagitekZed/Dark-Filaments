# Long-burn calibration — 2026-05-14T06:53:54.513Z
...
- DNF: 0/20
- Time to complete target tier p10 / p50 / p90: 1d 19h / 2d 16h / 3d 8h
- Total target range: 2d 2h - 4d 8h  →  drift -17.1%  [HIGH-under]
...
| T4 | 23h 12m | 15h 34m / 1d 18h | 1d 0h - 2d 0h | -35.5% | HIGH-under | 1.80e+11 / 5.00e+10 | 3.60× | above-band |

## Cross-pairing comparison (all pairings)

| Pairing | Mode | Weight | N | DNF | p10 | p50 | p90 | Total drift | T4 band | Kind |
|---|---|---|---|---|---|---|---|---|---|---|
| realistic-engaged × comp-hoarder | completion | primary | 20 | 0/20 | 1d 19h | 2d 16h | 3d 8h | -17.1% [HIGH-under] | 3.60× [above-band] | engagement-profile |

## Anomalies / flags

- realistic-engaged × comp-hoarder total: drift -17.1% [HIGH-under]
- realistic-engaged × comp-hoarder T4: p50 23h 12m vs target 1d 0h - 2d 0h → -35.5% [HIGH-under]
