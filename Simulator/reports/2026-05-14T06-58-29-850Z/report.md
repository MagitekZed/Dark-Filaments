# Long-burn calibration — 2026-05-14T06:58:29.862Z
...
- DNF: 0/20
- Time to complete target tier p10 / p50 / p90: 2d 23h / 3d 10h / 4d 8h
- Total target range: 1d 23h - 3d 14h  →  drift +23.7%  [HIGH-over]
- Active engagement p10 / p50 / p90: 3h 30m / 4h 30m / 5h 45m
...
| T4 | 1d 22h | 1d 14h / 2d 14h | 1d 0h - 1d 12h | +54.1% | HIGH-over | 5.76e+10 / 1.50e+9 | 38.52× | above-band |

## Cross-pairing comparison (all pairings)

| Pairing | Mode | Weight | N | DNF | p10 | p50 | p90 | Total drift | T4 band | Kind |
|---|---|---|---|---|---|---|---|---|---|---|
| realistic-engaged × thr-hoarder | threshold | primary | 20 | 0/20 | 2d 23h | 3d 10h | 4d 8h | +23.7% [HIGH-over] | 38.52× [above-band] | engagement-profile |

## Anomalies / flags

- realistic-engaged × thr-hoarder total: drift +23.7% [HIGH-over]
...
- realistic-engaged × thr-hoarder T4: p50 1d 22h vs target 1d 0h - 1d 12h → +54.1% [HIGH-over]
