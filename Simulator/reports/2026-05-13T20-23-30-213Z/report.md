# Long-burn calibration — 2026-05-13T20:23:30.216Z
...
|---|---|---|---|---|---|---|---|---|---|
| bot-60cpm × comp-hoarder | completion | 1 | 0/1 | 9h 41m | 9h 41m | 9h 41m | n/a | 0.69× [below-band] | ok |

## Cross-pairing comparison (all pairings)

| Pairing | Mode | Weight | N | DNF | p10 | p50 | p90 | Total drift | T3 band | Kind |
|---|---|---|---|---|---|---|---|---|---|---|
| bot-60cpm × comp-hoarder | completion | legacy | 1 | 0/1 | 9h 41m | 9h 41m | 9h 41m | n/a | 0.69× [below-band] | continuous-bot |

## Anomalies / flags

- bot-60cpm × comp-hoarder T1 mass band: ratio p50 0.65× < 0.7 [below-band]
- bot-60cpm × comp-hoarder T3 mass band: ratio p50 0.69× < 0.7 [below-band]
