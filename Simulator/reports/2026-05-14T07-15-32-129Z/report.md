# Long-burn calibration — 2026-05-14T07:15:32.140Z
...
- DNF: 0/20
- Time to complete target tier p10 / p50 / p90: 1d 23h / 2d 18h / 4d 0h
...
| T4 | 1d 2h | 18h 39m / 2d 0h | 1d 0h - 2d 0h | -26.2% | HIGH-under | 5.64e+11 / 1.00e+11 | 5.64× | above-band |

## Cross-pairing comparison (all pairings)

| Pairing | Mode | Weight | N | DNF | p10 | p50 | p90 | Total drift | T4 band | Kind |
|---|---|---|---|---|---|---|---|---|---|---|
| realistic-engaged × comp-hoarder | completion | primary | 20 | 0/20 | 1d 23h | 2d 18h | 4d 0h | -13.5% [within] | 5.64× [above-band] | engagement-profile |

## Anomalies / flags

- realistic-engaged × comp-hoarder T4: p50 1d 2h vs target 1d 0h - 2d 0h → -26.2% [HIGH-under]
