# Long-burn calibration — 2026-05-13T02:09:40.785Z
...
|---|---|---|---|---|---|---|---|---|---|
| hyper-onboard × greedy-vpc-1.5 | completion | 10 | 0/10 | 9s | 9s | 9s | n/a | 1.90× [within-band] | ok |

## Cross-pairing comparison (all pairings)

| Pairing | Mode | Weight | N | DNF | p10 | p50 | p90 | Total drift | T1 band | Kind |
|---|---|---|---|---|---|---|---|---|---|---|
| hyper-onboard × greedy-vpc-1.5 | completion | legacy | 10 | 0/10 | 9s | 9s | 9s | n/a | 1.90× [within-band] | continuous-bot |
