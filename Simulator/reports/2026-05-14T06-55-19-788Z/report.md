# Long-burn calibration — 2026-05-14T06:55:19.793Z
...
- DNF: 0/20
- Time to complete target tier p10 / p50 / p90: 1d 19h / 2d 12h / 3d 14h
- Total target range: 2d 2h - 4d 8h  →  drift -22.0%  [HIGH-under]
- Active engagement p10 / p50 / p90: 3h 0m / 3h 30m / 4h 0m
...
| T4 | 23h 23m | 15h 34m / 1d 9h | 1d 0h - 2d 0h | -35.0% | HIGH-under | 2.37e+11 / 5.00e+10 | 4.73× | above-band |

## Cross-pairing comparison (all pairings)

| Pairing | Mode | Weight | N | DNF | p10 | p50 | p90 | Total drift | T4 band | Kind |
|---|---|---|---|---|---|---|---|---|---|---|
| realistic-engaged × comp-hoarder | completion | primary | 20 | 0/20 | 1d 19h | 2d 12h | 3d 14h | -22.0% [HIGH-under] | 4.73× [above-band] | engagement-profile |

## Anomalies / flags

- realistic-engaged × comp-hoarder total: drift -22.0% [HIGH-under]
- realistic-engaged × comp-hoarder T4: p50 23h 23m vs target 1d 0h - 2d 0h → -35.0% [HIGH-under]
