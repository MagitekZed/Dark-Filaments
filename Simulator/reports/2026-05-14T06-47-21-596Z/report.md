# Long-burn calibration — 2026-05-14T06:47:21.608Z
...
- DNF: 0/20
- Time to complete target tier p10 / p50 / p90: 1d 19h / 2d 6h / 3d 8h
- Total target range: 2d 2h - 4d 8h  →  drift -30.0%  [HIGH-under]
- Active engagement p10 / p50 / p90: 2h 45m / 3h 15m / 4h 0m
...
| T4 | 17h 5m | 14h 49m / 1d 2h | 1d 0h - 2d 0h | -52.5% | HIGH-under | 9.07e+10 / 1.50e+10 | 6.04× | above-band |

## Cross-pairing comparison (all pairings)

| Pairing | Mode | Weight | N | DNF | p10 | p50 | p90 | Total drift | T4 band | Kind |
|---|---|---|---|---|---|---|---|---|---|---|
| realistic-engaged × comp-hoarder | completion | primary | 20 | 0/20 | 1d 19h | 2d 6h | 3d 8h | -30.0% [HIGH-under] | 6.04× [above-band] | engagement-profile |

## Anomalies / flags

- realistic-engaged × comp-hoarder total: drift -30.0% [HIGH-under]
- realistic-engaged × comp-hoarder T4: p50 17h 5m vs target 1d 0h - 2d 0h → -52.5% [HIGH-under]
